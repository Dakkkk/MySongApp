...
public class ItunesSongDetailsPresenter extends MvpPresenter<BaseSongDetailsView> {
    ...
    @Override
    public void attachView(BaseSongDetailsView view) {
        super.attachView(view);

        Log.d("DetailPresenter, song:", getSongTitle());
        view.showItunesSongDetails(getItunesSongDetails());

/*
        chosenSong = getSong();
*/
        /*Log.d("detailsPresenter: ", getSong());

        view.showItunesSongDetails(chosenSong);
*/
    }
